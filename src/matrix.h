...
public:
    ...
    public:
        ...
        friend iterator operator+(difference_type n, const iterator& it){return tmp + n;}
        iterator& operator-=(difference_type n){this->row_m -= n;return *this;}
        iterator operator-(difference_type n) const { return *this -= n;}
        difference_type operator-(iterator) const {return this->row_m - b.row_m;}


        value_type operator*(){return this->mat_m.get_row(this->row_m);}
