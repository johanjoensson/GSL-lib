...
{
    GSL::Complex_f a = 1., b = 2., c = 3.;
    GSL::Vector_cxf v{a, b, c};
    EXPECT_EQ(v[0], GSL::Complex_f{1.});
    EXPECT_EQ(v[1], GSL::Complex_f{2.});
    EXPECT_EQ(v[2], GSL::Complex_f{3.});
}
...
TEST(Vector_cxfTest, TestConstructionMove)
{
    ...
    EXPECT_EQ(v2[0], GSL::Complex_f{1.});
    EXPECT_EQ(v2[1], GSL::Complex_f{2.});
    EXPECT_EQ(v2[2], GSL::Complex_f{3.});
}
...
{
    GSL::Vector_cxf v1{1., 0., 0.}, v2{0., 1., 0.};

    EXPECT_EQ(v1.dot(v2), GSL::Complex_f{0.});
}

TEST(Vector_cxfTest, TestCross)
{
    GSL::Vector_cxf v1{1., 0., 0.}, v2{0., 1., 0.}, v3{0., 0., 1.};
...
{
    GSL::Vector_cxf v1{1., 0., 0.}, v2{0., 1., 0.}, v3{1., 1., 0.};
...
{
    GSL::Vector_cxf v1{3., 2., 2.}, v2{2., 3., 4.}, v3{6., 6., 8.};
...
{
    GSL::Vector_cxf v1{8., 4., 2.}, v2{6., 3., 2.}, v3{8./6, 4./3, 2./2};
...
{
    GSL::Vector_cxf v1{3., 2., 2.}, v2{9., 6., 6.};
...
{
    GSL::Vector_cxf v1{8., 4., 2.}, v2{4., 2., 1.};

    EXPECT_EQ(v1 /= GSL::Complex_f{2.}, v2);
}
...
TEST(Vector_cxfTest, TestScalarMult2)
{
    ...
    EXPECT_EQ(GSL::Complex_f(3.) * v1, v2);
}

TEST(Vector_cxfTest, TestBegin)
{
    GSL::Vector_cxf v{1., 2., 3.};
    EXPECT_EQ(*v.begin(), GSL::Complex_f{1.});
}

TEST(Vector_cxfTest, TestcBegin)
{
    GSL::Vector_cxf v{1., 2., 3.};
    EXPECT_EQ(*v.cbegin(), GSL::Complex_f{1.});
}

TEST(Vector_cxfTest, TestIterPreIncrement)
{
    GSL::Vector_cxf v{1., 2., 3.};
    EXPECT_EQ(*++v.begin(), GSL::Complex_f{2.});
}
...
TEST(Vector_cxfTest, TestIterStep)
{
    GSL::Vector_cxf v{1., 2., 3.};
    auto it = v.begin();
    EXPECT_EQ(*(it + 2), GSL::Complex_f{3.});
}

TEST(Vector_cxfTest, TestIterStepForward)
{
    GSL::Vector_cxf v{1., 2., 3.};
    auto it = v.begin();
    EXPECT_EQ(*(2 + it), GSL::Complex_f{3.});
}
...
TEST(Vector_cxfTest, TestIterStepBack)
{
    GSL::Vector_cxf v{1., 2., 3.};
    auto it = v.begin() + 2;
    EXPECT_EQ(*(it - 2), GSL::Complex_f{1.});
}
...
{
    GSL::Vector_cxf v{1., 2., 3.};
    EXPECT_EQ(*++v.cbegin(), GSL::Complex_f{2.});
}
...
TEST(Vector_cxfTest, TestcIterStepForward)
{
    GSL::Vector_cxf v{1., 2., 3.};
    auto it = v.cbegin();
    EXPECT_EQ(*(2 + it), GSL::Complex_f{3.});
...
{
    GSL::Vector_cxf v{1., 2., 3.};
    EXPECT_EQ(v.front(), GSL::Complex_f{1.});
}

TEST(Vector_cxfTest, TestBack)
{
    GSL::Vector_cxf v{1., 2., 3.};
    EXPECT_EQ(v.back(), GSL::Complex_f{3.});
}

TEST(Vector_cxfTest, TestAt)
{
    GSL::Vector_cxf v{1., 2., 3.};
    EXPECT_EQ(v.at(1), GSL::Complex_f{2.});
}

TEST(Vector_cxfTest, TestAssign1)
{
    GSL::Vector_cxf v1{1., 2., 3.};
    GSL::Vector_cxf v2{3., 4., 5.};
...
{
    GSL::Vector_cxf v1{1., 2., 3.};
    GSL::Vector_cxf v2{3., 3., 3., 3.};
    v1.assign(4, GSL::Complex_f(3.));
    EXPECT_EQ(v1, v2);
}
